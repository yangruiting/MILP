...
from subgraph_extraction.datasets import SubgraphDataset, generate_subgraph_datasets_test, generate_subgraph_datasets
...
def main(params):
    ...
    graph_classifier = initialize_model(params, None, load_model=True) #正常，加载保存的最好的模型(实验名称下)
    ...
    # plan 1, make prediction directly
    generate_subgraph_datasets_test(params, splits=['test'],
    ...
    # plan 2, use fine-tuning
    # generate_subgraph_datasets_test(params, splits=['train','test'],
    #                            saved_relation2id=graph_classifier.relation2id,
    #                            max_label_value=graph_classifier.max_label_value)
    # train = SubgraphDataset(params.db_path, 'train_pos', 'train_neg', params.file_paths, graph_classifier.relation2id,
    #                        add_traspose_rels=params.add_traspose_rels,
    #                        num_neg_samples_per_link=params.num_neg_samples_per_link,
    #                        use_kge_embeddings=params.use_kge_embeddings, dataset=params.dataset,
    ...
    for r in range(1, params.runs + 1):
        ...
        # plan 2
        # tester = Trainer(params, graph_classifier, train, test)
        # result = tester.finetuning()
