...
def get_subgraph(adj_list, hops, max_nodes_per_hop):
    '''
    在max_nodes_per_hop给出的每跳选择节点的限制下，围绕随机选择的根节点对子图进行采样
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", "-d", type=str, default="FB15K237 _demo",
                        help="Dataset string")
    parser.add_argument("--new_dataset", "-nd", type=str, default="fb_demo",
                        help="Dataset string")
